      ...
      <div className={styles.searchContainer + ' pure-g'}>
        <div className="pure-u-3-4">
          ...
          <form className="pure-form">
            <input type="text" className="pure-input-rounded" ref="notification" placeholder="Notification search" />
            <button type="submit" className={styles.secondaryButton + ' pure-button'} 
