...
import { childSection } from 'src/forms/register/fieldDefinitions/birth/child-section'
import { motherSection } from 'src/forms/register/fieldDefinitions/birth/mother-section'
