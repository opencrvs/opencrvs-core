...
export const BENGALI_STATE: ILanguage = {
  ...
  messages: {
    ...
    'register.registerForm.queryError': `{error, select, regError {ধীর  সংযোগ বা নেটওয়ার্ক ত্রুটির কারণে পেজটি  এই মুহূর্তে  লোড করা সম্ভব হচ্ছে  না। অনুগ্রহপূর্বক আবার চেষ্টা করার জন্য রিফ্রেশ  করুন, অথবা পুনরায়  চেষ্টা করুন।}}`
  }
}
