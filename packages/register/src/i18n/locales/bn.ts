...
export const BENGALI_STATE: ILanguage = {
  ...
  messages: {
    ...
    'form.field.label.imageUpload.delete': 'মুছে ফেলা',
    'form.field.label.imageUpload.preview': 'প্রিভিউ',
    ...
    'register.notification.outboxText': 'আউটবক্স({num})',
    'register.notification.processingText': '{num} টি আবেদন প্রক্রিয়াধীন...',
    'register.notification.sorryError': 'দুঃখিত কিছু ভুল হয়েছে',
