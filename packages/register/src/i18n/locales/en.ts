...
export const ENGLISH_STATE: ILanguage = {
  ...
  messages: {
    ...
    'buttons.rejectApplication': 'Reject Application',
    'buttons.retry': 'Retry',
    ...
    'buttons.sendIncomplete': 'Send incomplete application',
    ...
    'constants.localSystemAdmin': 'System admin (local)',
    'constants.login': 'Login',
    'constants.male': 'Male',
    'constants.mayor': 'Mayor',
    'constants.mother': 'Mother',
    'constants.nationalRegistrar': 'National Registrar',
    'constants.nationalSystemAdmin': 'System admin (national)',
    'constants.orgDivision': 'ORG Division',
    'constants.performanceManagement': 'Performance Management',
    'constants.performanceOversight': 'Performance Oversight',
    'constants.phoneNumber': 'Phone number',
    'constants.registrationClerk': 'Registration Clerk',
    ...
    'form.field.label.addressLine1': 'Street and house number',
    'form.field.label.addressLine2': 'Area / Ward / Mouja / Village',
    'form.field.label.addressLine3': 'Union / Municipality / Cantonement',
    'form.field.label.addressLine3CityOption': 'Ward',
    ...
    'form.field.label.applicantRelation.extendedFamily': 'Extended Family',
    'form.field.label.applicantRelation.father': 'Father',
    'form.field.label.applicantRelation.mother': 'Mother',
    'form.field.label.applicantRelation.other': 'Other(Specify)',
    'form.field.label.applicantRelation.son': 'Son',
    'form.field.label.applicantRelation.spouse': 'Spouse',
    'form.field.label.applicants.nationality': 'Nationality',
    ...
    'form.field.label.applicantsDateOfBirth': 'Date of Birth',
    'form.field.label.applicantsFamilyName': 'Last Name(s) in Bengali',
    'form.field.label.applicantsFamilyNameEng': 'Last Name(s) in English',
    'form.field.label.applicantsGivenNames': 'First Name(s) in Bengali',
    'form.field.label.applicantsGivenNamesEng': 'First Name(s) in English',
    'form.field.label.applicantsIdType': 'Existing ID',
    'form.field.label.applicantsRelationWithDeceased':
      'Relationship to Deceased',
    'form.field.label.application.certificateLanguage':
      'Which languages does the informant want the certificate issued in?',
    'form.field.label.application.certificateLanguage.other': 'Other',
    'form.field.label.application.commentsOrNotes': 'Comments or notes',
    ...
    'form.field.label.application.phone': 'Phone number',
    ...
    'form.field.label.application.whoIsPresent.both': 'Both Parents',
    'form.field.label.application.whoIsPresent.father': 'Father',
    'form.field.label.application.whoIsPresent.mother': 'Mother',
    'form.field.label.application.whoIsPresent.other': 'Other',
    'form.field.label.application.whoseContactDetails':
      'Who is the contact person for this application?',
    'form.field.label.application.whoseContactDetails.both': 'Both Parents',
    'form.field.label.application.whoseContactDetails.father': 'Father',
    'form.field.label.application.whoseContactDetails.mother': 'Mother',
    'form.field.label.application.whoseContactDetails.other': 'Other',
    ...
    'form.field.label.attendantAtBirthPhysician': 'Physician',
    ...
    'form.field.label.causeOfDeathCode': 'Cause of Death Code',
    'form.field.label.causeOfDeathEstablished':
      'Has a Cause of Death been established ?',
    'form.field.label.childDateOfBirth': 'Date of birth',
    'form.field.label.childFamilyName': 'Last Name(s) in Bengali',
    'form.field.label.childFamilyNameEng': 'Last Name(s) in English',
    'form.field.label.childFirstNames': 'First Name(s) in Bengali',
    'form.field.label.childFirstNamesEng': 'First Name(s) in English',
    'form.field.label.childSex': 'Sex',
    'form.field.label.childSexFemale': 'Female',
    'form.field.label.childSexMale': 'Male',
    'form.field.label.childSexOther': 'Other',
    'form.field.label.childSexUnknown': 'Unknown',
    'form.field.label.confirm': 'Yes',
    'form.field.label.country': 'Country',
    'form.field.label.currentAddress': 'Current Address',
    ...
    'form.field.label.deathPlaceAddressOther': 'Different Address',
    'form.field.label.deathPlaceAddressSameAsCurrent':
      'Current address of the deceased',
    'form.field.label.deathPlaceAddressSameAsPermanent':
      'Permanent address of the deceased',
    'form.field.label.deathPlaceAddressType': 'Type of Place',
    'form.field.label.deceased.nationality': 'Nationality',
    'form.field.label.deceasedCurrentAddressSameAsPermanent':
      'Is deceased’s current address the same as their permanent address?',
    'form.field.label.deceasedDateOfBirth': 'Date of Birth',
    'form.field.label.deceasedDeathProof': 'Proof of Death of Deceased',
    'form.field.label.deceasedDoBProof': 'Proof of Date of Birth of Deceased',
    'form.field.label.deceasedDocumentParagraph':
      'For this death registration, the following documents are required:',
    'form.field.label.deceasedFamilyName': 'Last Name(s) in Bengali',
    'form.field.label.deceasedFamilyNameEng': 'Last Name(s) in English',
    'form.field.label.deceasedGivenNames': 'First Name(s) in Bengali',
    'form.field.label.deceasedGivenNamesEng': 'First Name(s) in English',
    ...
    'form.field.label.deceasedSex': 'Sex',
    'form.field.label.deceasedSexFemale': 'Female',
    'form.field.label.deceasedSexMale': 'Male',
    'form.field.label.deceasedSexOther': 'Other',
    'form.field.label.deceasedSexUnknown': 'Unknown',
    ...
    'form.field.label.docTypeBR': 'Birth Registration',
    ...
    'form.field.label.docTypeDeathCertificate': 'Attested Certificate of Death',
    ...
    'form.field.label.docTypeNIDBack': 'National ID (back)',
    'form.field.label.docTypeNIDFront': 'National ID (front)',
    ...
    'form.field.label.educationAttainmentISCED4': 'Post secondary',
    'form.field.label.educationAttainmentISCED5': 'First stage tertiary',
    ...
    'form.field.label.fatherDateOfBirth': 'Date of birth',
    'form.field.label.fatherEducationAttainment':
      "Father's level of formal education attained",
    'form.field.label.fatherFamilyName': 'Last Name(s) in Bengali',
    'form.field.label.fatherFamilyNameEng': 'Last Name(s) in English',
    ...
    'form.field.label.fetchInformantDetails': "Retrieve Informant's Details",
    'form.field.label.fetchMotherDetails': "Retrieve Mother's Details",
    ...
    'form.field.label.medicallyCertified': 'Medically Certified Cause of Death',
    ...
    'form.field.label.motherDateOfBirth': 'Date of birth',
    'form.field.label.motherEducationAttainment':
      "Mother's level of formal education attained",
    'form.field.label.motherFamilyName': 'Last Name(s) in Bengali',
    'form.field.label.motherFamilyNameEng': 'Last Name(s) in English',
    'form.field.label.motherFirstNames': 'First Name(s) in Bengali',
    'form.field.label.motherFirstNamesEng': 'First Name(s) in English',
    'form.field.label.multipleBirth': 'Order of birth (number)',
    'form.field.label.optionalLabel': 'Optional',
    'form.field.label.otherHealthInstitution': 'Other Health Institution',
    'form.field.label.otherInstitution': 'Other',
    'form.field.label.otherOption': 'Other',
    'form.field.label.permanentAddress': 'Permanent Address',
    'form.field.label.permanentAddressSameAsMother':
      "Is his permanent address the same as the mother's?",
    'form.field.label.placeOfBirth': 'Place of delivery',
    'form.field.label.postCode': 'Postcode',
    ...
    'form.field.label.print.otherPersonFamilyName': 'Family name',
    ...
    'login.session.expired': 'Your session has expired. Please login again.',
    ...
    'print.certificate.section.title': 'Certificate Collection',
    ...
    'home.header.placeHolderPhone': 'Enter Phone No.',
    'home.header.placeHolderTrackingId': 'Enter Tracking ID',
    ...
    'notification.outboxText': 'Outbox({num})',
    'notification.processingText': '{num} application processing...',
    'notification.sorryError': 'Sorry! Something went wrong',
    'notification.userFormSuccess': 'New user created',
    ...
    'user.form.label.firstNameBN': 'Bengali first name',
    'user.form.label.firstNameEN': 'English first name',
    'user.form.label.lastNameBN': 'Bengali last name',
    'user.form.label.lastNameEN': 'English last name',
    'user.form.label.NID': 'NID',
    'user.form.label.registrationOffice': 'Registration Office',
    'user.form.label.userDevice': 'Device',
    'user.form.label.username': 'Username',
    'user.form.preview.title': 'Please review the new users details',
