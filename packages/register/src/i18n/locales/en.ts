...
export const ENGLISH_STATE: ILanguage = {
  ...
  messages: {
    ...
    'register.registerForm.queryError': `{error, select, regError {The page cannot be loaded at this time due to low connectivity or a network error. Please click refresh to try again, or try again later.}}`
  }
}
