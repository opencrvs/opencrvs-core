...
3. `REGISTER`
 ...
 4.2 `MARK_AS_DUPLICATE` - Automated action generated by deduplication process.
 4.3 `MARK_AS_NOT_DUPLICATE` - Declaration was marked as duplicate by the system, but can be marked as not by the user.
