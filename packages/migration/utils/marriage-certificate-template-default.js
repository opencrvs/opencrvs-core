...
<image id="image_groom" width="1222" height="446" xlink:href="{{groomSignature}}"/>
<image id="image_bride" width="1222" height="446" xlink:href="{{brideSignature}}"/>
<image id="image_registrar" width="1222" height="446" xlink:href="{{registrarSignature}}"/>
<image id="image_qrcode" width="1222" height="446" xlink:href="{{qrCode}}"/>
</defs>
</svg>`
