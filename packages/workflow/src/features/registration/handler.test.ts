...
import { testFhirBundle, testFhirBundleWithIds } from '../../test/utils'
...
const fieldAgentPractitionerMock = JSON.stringify({
  resourceType: 'Bundle',
...
const fieldAgentPractitionerRoleMock = JSON.stringify({
  entry: [
    {
      fullUrl:
...
const districtMock = JSON.stringify({
...
const upazilaMock = JSON.stringify({
  resourceType: 'Location',
  identifier: [
    {
      system: 'http://opencrvs.org/specs/id/a2i-internal-id',
...
const unionMock = JSON.stringify({
  resourceType: 'Location',
  identifier: [
    {
      system: 'http://opencrvs.org/specs/id/a2i-internal-id',
...
const officeMock = JSON.stringify({
  resourceType: 'Location',
  identifier: [
    {
      system: 'http://opencrvs.org/specs/id/a2i-internal-id',
...
describe('Verify handler', () => {
  ...
  describe('markBirthAsCertifiedHandler', () => {
    beforeEach(() => {
      fetch.mockResponses(
        [userMock, { status: 200 }],
        [fieldAgentPractitionerMock, { status: 200 }],
