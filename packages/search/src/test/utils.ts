...
export const mockTestDeleteIndex = {
  body: {
    acknowledged: true
  },
  statusCode: 200,
  headers: {
    ...
    warning:
      '299 Elasticsearch-7.17.0-bee86328705acaa9a6daede7140defd4d9ec56bd "Elasticsearch built-in security features are not enabled. Without authentication, your cluster could be accessible to anyone. See https://www.elastic.co/guide/en/elasticsearch/reference/7.17/security-minimal-setup.html to enable security."',
  ...
  meta: {
    ...
    request: {
      params: {
        ...
        headers: {
          'user-agent':
            'elasticsearch-js/7.17.0 (linux 5.13.0-40-generic-x64; Node.js v14.18.1)',
          'x-elastic-client-meta': 'es=7.17.0,js=14.18.1,t=7.17.0,hc=14.18.1'
        },
        timeout: 30000
      },
      options: {},
