...
<Story name="Neutral" storyName="Neutral">
  <ToastToggler type="neutral">Hi! I'm a neutral toast</ToastToggler>
</Story>
...
<Story name="Error" storyName="Error">
  <ToastToggler type="warning">Hi! I'm an error toast</ToastToggler>
</Story>
...
<Story name="Retryable" storyName="Retryable">
  <ToastToggler type="loading" retryable>
...
<Story name="Retryable and closable" storyName="Retryable and closable">
  <ToastToggler type="loading" retryable closable>
...
>
  <ToastToggler type="success" retryable closable>
