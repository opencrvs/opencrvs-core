...
export const Icon = () => (
  <Stack>
    <Button icon size="large" aria-label="View performance data">
      <Activity />
    </Button>
    <Button icon size="medium" aria-label="View performance data">
      <Activity />
    </Button>
    <Button icon size="small" aria-label="View performance data">
      <Activity />
    </Button>
  </Stack>
)
