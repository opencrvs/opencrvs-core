...
export const Icon = () => (
  <Stack>
    ...
    <Button type="iconSolid" size="large" aria-label="View performance data">
      <Activity />
    </Button>
    <Button type="iconSolid" size="medium" aria-label="View performance data">
      <Activity />
    </Button>
    <Button type="iconSolid" size="small" aria-label="View performance data">
      <Activity />
    </Button>
  </Stack>
)
