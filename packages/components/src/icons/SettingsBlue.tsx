...
export const SettingsBlue = ({
  color = 'feedback/info',
  ...props
}: { color?: SemanticColor } & React.SVGAttributes<SVGElement>) => (
  <svg width={24} height={24} fill="none" {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"
      stroke={lightColors[color]}
      strokeWidth={2}
      strokeLinecap="round"
