...
export const defaultFormsConfig = {
  registerForm: {
    birth: {
      sections: [
        {
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      label: {
                        ...
                        description:
                          'Option for form field: Other family member',
              ...
              fields: [
                {
                  ...
                  label: {
                    ...
                    description:
                      'Label for form field: reasonMotherNotApplying',
                ...
                },
                {
                  ...
                  label: {
                    ...
                    description:
                      'Label for form field: reasonFatherNotApplying',
                        ...
                        mapping: {
                          mutation: {
                            ...
                            parameters: [
                              {
                                operation:
                                  'fieldToReasonsNotApplyingTransformer',
                                parameters: [
                                  'reasonsNotApplying',
                                  'reasonNotApplying',
                                  'primaryCaregiverType'
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      label: {
                        ...
                        description:
                          'Label for select option Birth Registration',
                  ...
                  options: [
                    {
                      ...
                      label: {
                        defaultMessage: 'Yes',
                        description:
                          'Option for form field: Deceased has spouse',
                  ...
                  options: [
                    ...
                    },
                    {
                      ...
                      label: {
                        ...
                        description:
                          'Label for select option Post Mortem Report',
