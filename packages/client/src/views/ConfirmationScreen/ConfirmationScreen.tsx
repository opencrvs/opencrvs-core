...
import {
  ...
  FooterAction,
  FooterPrimaryButton
} from '@opencrvs/client/src/components/interface/footer'
import { RouteComponentProps } from 'react-router'
import { IStoreState } from '@client/store'
import { IntlState } from '@client/i18n/reducer'
import { DECLARATION, REJECTION, BIRTH, OFFLINE } from '@client/utils/constants'
import { HomeViewHeader } from '@client/components/HomeViewHeader'
import { messages } from '@client/i18n/messages/views/confirmationScreen'
