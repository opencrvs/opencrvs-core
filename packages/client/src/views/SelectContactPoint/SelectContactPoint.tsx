...
import { IInformantField } from '@client/views/SelectInformant/SelectInformant'
import { Event, IFormSection, BirthSection, DeathSection } from '@client/forms'
import { messages } from '@client/i18n/messages/views/selectContactPoint'
import {
  formMessages,
  constantsMessages,
  buttonMessages
