...
const DRAFT_BIRTH_PARENT_FORM = `/drafts/:declarationId/events/${EventType.Birth}`
const DRAFT_BIRTH_PARENT_FORM_PAGE = `/drafts/:declarationId/events/${EventType.Birth}/:pageId`
const DRAFT_BIRTH_PARENT_FORM_PAGE_GROUP = `/drafts/:declarationId/events/${EventType.Birth}/:pageId/group/:groupId`
const SELECT_DEATH_INFORMANT = `/drafts/:declarationId/events/${EventType.Death}/registration/informantType`
const DRAFT_DEATH_FORM = `/drafts/:declarationId/events/${EventType.Death}`
const DRAFT_DEATH_FORM_PAGE = `/drafts/:declarationId/events/${EventType.Death}/:pageId`
const DRAFT_DEATH_FORM_PAGE_GROUP = `/drafts/:declarationId/events/${EventType.Death}/:pageId/group/:groupId`
const SELECT_MARRIAGE_INFORMANT = `/drafts/:declarationId/events/${EventType.Marriage}/registration/informantType`
const DRAFT_MARRIAGE_FORM = `/drafts/:declarationId/events/${EventType.Marriage}`
const DRAFT_MARRIAGE_FORM_PAGE = `/drafts/:declarationId/events/${EventType.Marriage}/:pageId`
const DRAFT_MARRIAGE_FORM_PAGE_GROUP = `/drafts/:declarationId/events/${EventType.Marriage}/:pageId/group/:groupId`

const REVIEW_EVENT_PARENT_FORM_PAGE =
  '/reviews/:declarationId/events/:event/parent/:pageId'

const REVIEW_EVENT_PARENT_FORM_PAGE_GROUP =
  '/reviews/:declarationId/events/:event/parent/:pageId/group/:groupId'

const REVIEW_CORRECTION = '/review-correction/:declarationId'

export const CERTIFICATE_CORRECTION = '/correction/:declarationId/:pageId'

const CERTIFICATE_CORRECTION_REVIEW =
...
const VS_EXPORTS = '/vsexports'

export const EVENT_COMPLETENESS_RATES =
  '/performance/operations/completenessRates/:eventType'
const WORKFLOW_STATUS = '/performance/operations/workflowStatus'
const PERFORMANCE_FIELD_AGENT_LIST = '/performance/field-agents'
...
const VIEW_RECORD = '/:declarationId/viewRecord'
...
const PRINT_RECORD = '/print-record/:declarationId'
