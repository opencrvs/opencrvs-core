...
setMutationDefaults(utils.event.actions.reject, {
  mutationFn: createMutationFn(utils.event.actions.reject),
  retry: true,
  retryDelay: 10000,
  onSuccess: updateLocalEvent,
  meta: {
...
setMutationDefaults(utils.event.actions.archive, {
  mutationFn: createMutationFn(utils.event.actions.archive),
  retry: true,
  retryDelay: 10000,
  onSuccess: updateLocalEvent,
  meta: {
