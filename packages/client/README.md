The OpenCRVS client app was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
...
Docker adds production environment variables and they must be added into the main OpenCRVS package Dockerfile-client
