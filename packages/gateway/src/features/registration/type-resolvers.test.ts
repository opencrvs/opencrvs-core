...
const fakeUser = {
  ...
  mobile: '0934343434',
  passwordHash: '$2a$10$1Sum2KY72RZ9j4Z9tcVOhumNYy1T2M9kLovvhkT.j2VpAcKdOBKVe',
  salt: '$2a$10$1Sum2KY72RZ9j4Z9tcVOhu',
  systemRole: 'LOCAL_REGISTRAR',
  role: {
    _id: '6501acb281245ece9e627ba4',
    __v: 0,
    createdAt: '2023-09-13T12:36:02.580Z',
    labels: [
      {
        lang: 'en',
    ...
    updatedAt: '2023-09-13T12:36:02.580Z'
  },
...
jest.mock('@gateway/search', () => {
  ...
  return {
    ...originalModule,
    getRecordById: () => Promise.resolve(BUNDLE)
  }
})
...
test('should return a valid bundle', async () => {
