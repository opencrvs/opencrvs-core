...
export const enum GQLEducationType {
  ...
  MODERN = 'MODERN',
  SECONDARY = 'SECONDARY',
  HIGHER_SCHOOL = 'HIGHER_SCHOOL',
  POLYTECNIC_NCE = 'POLYTECNIC_NCE',
...
export const enum GQLLocationType {
  ...
  TRADITIONAL_HERBALIST = 'TRADITIONAL_HERBALIST',
  SPIRITUAL_HOMES = 'SPIRITUAL_HOMES',
  OTHER = 'OTHER'
}
...
export const enum GQLInformantType {
  ...
  MOTHERS_BROTHER = 'MOTHERS_BROTHER',
  MOTHERS_SISTER = 'MOTHERS_SISTER',
  FATHERS_BROTHER = 'FATHERS_BROTHER',
  FATHERS_SISTER = 'FATHERS_SISTER',
  OTHER = 'OTHER'
}
...
export interface QueryToGetOfficewiseRegistrationsArgs {
  timeStart: string
  timeEnd: string
  event: string
  locationId: string
}
export interface QueryToGetOfficewiseRegistrationsResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLOfficewiseRegistrationTypeResolver<TParent = any> {
  officeLocation?: OfficewiseRegistrationToOfficeLocationResolver<TParent>
  total?: OfficewiseRegistrationToTotalResolver<TParent>
}

export interface OfficewiseRegistrationToOfficeLocationResolver<
  TParent = any,
  TResult = any
> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult
...
export interface OfficewiseRegistrationToTotalResolver<
  TParent = any,
  TResult = any
> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult
...
export interface GQLHumanNameTypeResolver<TParent = any> {
  ...
  middleNames?: HumanNameToMiddleNamesResolver<TParent>
...
export interface HumanNameToMiddleNamesResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult
}
