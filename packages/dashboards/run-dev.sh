...
export OPENCRVS_METABASE_SUPERUSER_PASSWORD_SALT=$(uuidgen)
export OPENCRVS_METABASE_SUPERUSER_PASSWORD=${OPENCRVS_METABASE_SUPERUSER_PASSWORD:-"password"}
export OPENCRVS_METABASE_SUPERUSER_PASSWORD_HASH=$(node "${BUILD_PATH}/generatePasswordHash.js" "$OPENCRVS_METABASE_SUPERUSER_PASSWORD_SALT$OPENCRVS_METABASE_SUPERUSER_PASSWORD")
