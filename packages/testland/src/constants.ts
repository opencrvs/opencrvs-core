...
export const MOSIP_INTEGRATION_CLIENT_ID = env.MOSIP_INTEGRATION_CLIENT_ID
export const MOSIP_INTEGRATION_CLIENT_SECRET =
  env.MOSIP_INTEGRATION_CLIENT_SECRET
