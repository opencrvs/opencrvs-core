...
export const locationParentHandler: ServerRoute['handler'] = async (req) => {
  ...
  const partOf = resourceIdentifierToUUID(location.partOf.reference)
  const parent = find(locations, { id: partOf })
