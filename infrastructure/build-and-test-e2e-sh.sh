...
echo "wait-on tcp:4040" && wait-on -l tcp:4040 && echo "wait-on tcp:3030" && wait-on -l tcp:3030 && echo "wait-on tcp:2020" && wait-on -l tcp:2020 && echo "wait-on tcp:7070" && wait-on -l tcp:7070 && echo "wait-on tcp:5050" && wait-on -l tcp:5050 && echo "wait-on tcp:9090" && wait-on -l tcp:9090 && echo "wait-on tcp:1050" && wait-on -l tcp:1050 && echo "wait-on tcp:3447" && wait-on -l tcp:3447 && echo "wait-on tcp:5001" && wait-on -l tcp:5001 && echo "wait-on tcp:27017" && wait-on -l tcp:27017 && echo "wait-on tcp:6379" && wait-on -l tcp:6379 && echo "wait-on tcp:9200" && wait-on -l tcp:9200 && echo "wait-on http://localhost:9200" && wait-on -l http://localhost:9200 && echo "wait-on tcp:8086" && wait-on -l tcp:8086 && echo "wait-on http://localhost:8086/ping" && wait-on -l http://localhost:8086/ping && echo "wait-on http://localhost:3000" && wait-on -l http://localhost:3000 && echo "wait-on http://localhost:3020" && wait-on -l http://localhost:3020
